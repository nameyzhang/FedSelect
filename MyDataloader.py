...
def load_server_data(args):
    ...
    corruption_matrix = uniform_corruption(0.2, num_classes)
...
def load_client_weight_data(dataset_name, batch_size, select_samples_ratio, weight, client_index, loader):
